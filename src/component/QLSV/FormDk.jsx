      ...
      <div>
        ...
        >
          ...
          <div className="mt-4 ml-5 flex justify-start">
            <button
              type="submit"
              className={`pr-6 pl-6 pt-4 pb-4 bg-green-300 cursor-pointer hover:bg-green-900 text-white text-[15px] ${!this.props.selectedUser ? "" : "hidden"
                }
    `}
            >
              Thêm Sinh Viên
            ...
            <button
              type="submit"
              className={`pr-6 pl-6 pt-4 pb-4 bg-blue-300 cursor-pointer hover:bg-blue-900 text-white text-[15px] ${this.props.selectedUser ?? "hidden"
                }`}
            >
              Cập Nhật
            </button>
          ...
          <div className=" ml-5 mt-10">
            ...
            <div>
              <input
                ...
                className="ml-3 border-gray-300 border-2 p-3  w-[500px]"
                onChange={this.handleFind} />
              <button
                type="button"
                title="search"
                className="pr-6 pl-6 pt-3 pb-3 ml-3 bg-blue-600 cursor-pointer hover:bg-blue-700 text-white text-[20px]"
